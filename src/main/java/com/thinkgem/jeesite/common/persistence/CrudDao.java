...
public interface CrudDao<T> extends BaseDao {
	 ...
	 * @return
	 */
	public List<T> findNewList(T entity);
	 ...
	 * @return
	 */
	public List<T> findJobList(T entity);
	/**
	 * 查询数据列表，如果需要分页，请设置分页对象，如：entity.setPage(new Page<T>());
	 * @param entity
	 * @return
	 ...
	 * @return
	 */
	public List<T> searchArticlePage(T entity);
	 ...
	 * @return
	 */
	public List<T> findconsultationArticlePage(T entity);
