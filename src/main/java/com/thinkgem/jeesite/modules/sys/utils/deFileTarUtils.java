 ...
 */
public class deFileTarUtils {
    /**
     * 进行base64加密，防止中文乱码
     */
    private static Class clazz = deFileTarUtils.class;
    ...
    public static void main(String[] args) {
        String sourcePath = "F:\\config.tar.gz";
        String destPath = "F:\\myZip.tar";
        try {
            gzipDecompression(sourcePath, destPath);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
