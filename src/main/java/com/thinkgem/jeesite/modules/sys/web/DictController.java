...
public class DictController extends BaseController {
	...
	/*	List<String> typeList = dictService.findTypeList();*/
		List<String> descriptionList = dictService.findDescriptionList();
	...
	public ReturnEntity<List<Dict>> findJobSelect(@RequestParam(required=false) String type) {
		...
		try{
			...
			LogUtils.getLogInfo(DictController.class).info("查询搜索条件出错",e);
			e.printStackTrace();
			return ReturnEntity.fail("查询搜索条件出错");
		}
		return ReturnEntity.success(list ,"查询条件成功");
	}
