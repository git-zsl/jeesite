...
<body>
	...
	<div class="footer">
		Copyright &copy; 2019 <a href="${pageContext.request.contextPath}${fns:getFrontPath()}">${fns:getConfig('productName')}</a> - Powered By <a href="http://ZSL.com" target="_blank">ZSL</a> ${fns:getConfig('version')}
	</div>
