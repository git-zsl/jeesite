    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#provence").change(function (e) {
                var url = "${ctx}/sys/area/city?name=" + e.val;
                $.ajax({
                    type: "GET",
                    url: url,
                    async: false,
            ...
            $("#city").change(function (e) {
                var url1 = "${ctx}/sys/area/district?name=" + e.val;
                $.ajax({
                    type: "GET",
                    url: url1,
                    async: false,
...
<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/user/save" method="post" class="form-horizontal">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <form:textarea path="information" htmlEscape="false" rows="3" maxlength="2000" class="input-xlarge"/>
        </div>
    </div>
    <div class="control-group">
